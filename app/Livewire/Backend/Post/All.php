...
class All extends Component
{
    ...
    public function changeHinactive()
    {
        ...
        $post->update($data);
        session()->flash('warning', 'Post Change to Headline non active was successfully');
        return redirect()->to('backend/posts');
    }
    ...
    public function changeSelection()
    {
        ...
        $post->update($data);
        session()->flash('warning', 'Post Change to Selection active was successfully');
        return redirect()->to('backend/posts');
    }
    ...
    public function changeDraft()
    {
        ...
        $post->update($data);
        session()->flash('warning', 'Post Change to Draft was successfully');
        return redirect()->to('backend/posts');
    }
    ...
    public function delete()
    {
        ...
        return redirect()->to('backend/posts')->with('danger', 'Post send to trash was successfully');
    }

    public function render()
    {
        return view('livewire.backend.post.all',[

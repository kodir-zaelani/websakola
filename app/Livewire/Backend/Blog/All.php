...
class All extends Component
{
    ...
    public function getPostallQueryProperty()
    {
        ...
        return Post::with('author', 'postcategory', 'tags')->orderBy($this->sortColumn, $this->sortDirection)
        ->where('statuspost', '1')
    ...
    public function changeHinactive()
    {
        ...
        $post->update($data);
        session()->flash('warning', 'Blog Change to Headline non active was successfully');
    ...
    public function changeSelection()
    {
        ...
        $post->update($data);
        session()->flash('warning', 'Blog Change to Selection active was successfully');
        return redirect()->to('backend/blog');
    }
    ...
    public function changeDraft()
    {
        ...
        $post->update($data);
        session()->flash('warning', 'Blog Change to Draft was successfully');
        return redirect()->to('backend/blog');
    }
    ...
    {
        return view('livewire.backend.blog.all',[

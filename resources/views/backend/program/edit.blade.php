...
<div class="content-header">
    <div class="d-flex align-items-center">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('backend.dashboard') }}"><i class="fa fa-home"><span
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                href="{{ route('backend.program.index') }}">All Prograam</a></li>
        ...
        <section class="content">
            <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.program.update', $program) }}"
            method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-8 col-12">
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title">Edit a Program
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ...
                                    value="{{ old('title') ?? $program->title }}" placeholder="Title" required>
                                </div>
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group ">
                                    ...
                                    <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" value="{{old('icon') ?? $program->icon}}" placeholder="Icon" required autofocus>
                                </div>
                                <small>
                            ...
                            <div class="form-group">
                                ...
                                name="content">{{ old('content') ?? $program->content }}</textarea>
                                @error('content')
                                <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <div class=" fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                        <img src="{{ $program->imageThumbUrl ? $program->imageThumbUrl : '/assets/images/no_image.png' }}"
                                        alt="...">
                                    </div>

...
<div class="content-header">
    <div class="d-flex align-items-center">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('backend.dashboard') }}"><i class="fa fa-home"><span
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                href="{{ route('backend.program.index') }}">Program</a></li>
        ...
        <section class="content">
            <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.program.store') }}" method="post">
                <div class="row">
                    @csrf
                    <div class="col-lg-8 col-12">
                        <div class="box">
                            <div class="box-header">
                                <h4 class="box-title">Create a Program
                                </h4>
                            </div>
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" value="{{old('icon')}}" placeholder="Icon" required autofocus>
                                        <small>
                    ...
                    <div class="col-lg-4 col-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h4 class="box-title">
                                    Cover Album <span class="text-danger">*</span>
                                </h4>
                            </div>

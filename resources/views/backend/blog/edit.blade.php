...
@section('content')
    ...
    <section class="content">
        <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.blog.update', $post) }}"
            method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-8 col-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                @if ($post->video)
                                    <div class="border-0 rounded-lg shadow-sm box">
                                        <div class="text-center box-body">
                                            <iframe width="560" height="315"
                                                src="https://www.youtube.com/embed/{{ $post->video }}" frameborder="0"

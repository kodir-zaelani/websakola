...
@section('content')
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row align-items-center">
          <div class="order-2 col-lg-6 order-lg-1" data-aos="fade-right" data-aos-delay="200">
          ...
          <div class="order-1 col-lg-6 order-lg-2" data-aos="fade-left" data-aos-delay="300">
            <div class="hero-visual">
              <div class="hero-image-wrapper">
                <img src="{{ asset('') }}assets/frontend/img/illustration/illustration-15.webp" class="img-fluid hero-image" alt="Hero Image">
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="visual-section">
              <div class="main-image-container">
                <img src="{{ asset('') }}assets/frontend/img/about/about-8.webp" alt="Professional team collaboration" class="img-fluid main-visual">
              ...
              <div class="secondary-images">
                <div class="row g-3">
                  <div class="col-6">
                    <img src="{{ asset('') }}assets/frontend/img/about/about-11.webp" alt="Team meeting" class="img-fluid secondary-img">
                  </div>
                  <div class="col-6">
                    <img src="{{ asset('') }}assets/frontend/img/about/about-5.webp" alt="Office workspace" class="img-fluid secondary-img">
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="col-lg-7">
                  <div class="visual-content">
                    <div class="main-image">
                      <img src="{{ asset('') }}assets/frontend/img/features/features-4.webp" alt="" class="img-fluid">
            ...
            <div class="tab-pane fade" id="features-tab-2">
              <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                  <div class="visual-content">
                    <div class="main-image">
                      <img src="{{ asset('') }}assets/frontend/img/features/features-2.webp" alt="" class="img-fluid">
                      <div class="floating-card">
                        <i class="bi bi-shield-check"></i>
                        <div class="card-content">
                          <span>Security</span>
            ...
            <div class="tab-pane fade" id="features-tab-3">
              <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                  <div class="visual-content">
                    <div class="main-image">
                      <img src="{{ asset('') }}assets/frontend/img/features/features-6.webp" alt="" class="img-fluid">
                      <div class="floating-card">
            ...
            <div class="tab-pane fade" id="features-tab-4">
              <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                  <div class="visual-content">
                    <div class="main-image">
                      <img src="{{ asset('') }}assets/frontend/img/features/features-1.webp" alt="" class="img-fluid">
                      <div class="floating-card">
                        <i class="bi bi-headset"></i>
                        <div class="card-content">
                          <span>Support</span>
        ...
        <div class="row g-4">
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="150">
            <div class="feature-card">
              ...
              <div class="feature-image">
                <img src="{{ asset('') }}assets/frontend/img/features/features-1.webp" alt="Dashboard Interface" class="img-fluid" loading="lazy">
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="feature-card highlighted">
              ...
              <div class="feature-image">
                <img src="{{ asset('') }}assets/frontend/img/features/features-2.webp" alt="Analytics Tools" class="img-fluid" loading="lazy">
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="250">
            <div class="feature-card">
              ...
              <div class="feature-image">
                <img src="{{ asset('') }}assets/frontend/img/features/features-3.webp" alt="Security Features" class="img-fluid" loading="lazy">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row align-items-center">
            <div class="col-lg-6" data-aos="zoom-in">
              <div class="testimonial-image">
                <img src="{{ asset('') }}assets/frontend/img/features/features-4.webp" alt="Testimonial" class="img-fluid">
              </div>
            </div>
        ...
        <div class="row align-items-lg-center">
          <div class="col-lg-5 order-lg-2" data-aos="fade-left" data-aos-delay="200">
            <div class="image-wrapper position-relative">
              ...
              <img src="{{ asset('') }}assets/frontend/img/misc/misc-6.webp" alt="Security Solutions" class="img-fluid main-image">
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="{{ asset('') }}assets/frontend/img/clients/clients-1.webp" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ asset('') }}assets/frontend/img/clients/clients-2.webp" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ asset('') }}assets/frontend/img/clients/clients-3.webp" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ asset('') }}assets/frontend/img/clients/clients-4.webp" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ asset('') }}assets/frontend/img/clients/clients-5.webp" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ asset('') }}assets/frontend/img/clients/clients-6.webp" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ asset('') }}assets/frontend/img/clients/clients-7.webp" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ asset('') }}assets/frontend/img/clients/clients-8.webp" class="img-fluid" alt=""></div>
          </div>
        </div>
        ...
        <div class="testimonial-masonry">
            ...
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('') }}assets/frontend/img/person/person-f-7.webp" alt="Client">
                </div>
          ...
          <div class="testimonial-item highlight" data-aos="fade-up" data-aos-delay="100">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('') }}assets/frontend/img/person/person-m-7.webp" alt="Client">
                </div>
                <div class="client-details">
                  <h3>Daniel Morgan</h3>
          ...
          <div class="testimonial-item" data-aos="fade-up" data-aos-delay="200">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('') }}assets/frontend/img/person/person-f-8.webp" alt="Client">
                </div>
                <div class="client-details">
                  <h3>Emma Thompson</h3>
          ...
          <div class="testimonial-item" data-aos="fade-up" data-aos-delay="300">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('') }}assets/frontend/img/person/person-m-8.webp" alt="Client">
                </div>
                <div class="client-details">
          ...
          <div class="testimonial-item highlight" data-aos="fade-up" data-aos-delay="400">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('') }}assets/frontend/img/person/person-f-9.webp" alt="Client">
                </div>
                <div class="client-details">
                  <h3>Olivia Carter</h3>
          ...
          <div class="testimonial-item" data-aos="fade-up" data-aos-delay="500">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('') }}assets/frontend/img/person/person-m-13.webp" alt="Client">
                </div>
                <div class="client-details">
                  <h3>Nathan Brooks</h3>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row">
          <div class="mx-auto mb-5 text-center col-lg-8" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="container">
        ...
        <div class="mb-5 pricing-toggle-container" data-aos="zoom-in" data-aos-delay="150">
          <div class="gap-3 px-3 py-2 pricing-toggle d-inline-flex align-items-center rounded-pill">
          ...
          <p class="mt-3 mb-0 hint small">Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.</p>
        </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <article class="price-card h-100">
              ...
              <ul class="mb-4 feature-list list-unstyled">
        ...
        <div class="row g-5">
          <div class="col-lg-6">
            <div class="content" data-aos="fade-up" data-aos-delay="200">
              <div class="mb-3 section-category">Contact US</div>
              <h2 class="mb-4 display-5">Nemo enim ipsam voluptatem quia voluptas aspernatur</h2>
              <p class="mb-4 lead">Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam.</p>

              <div class="mt-5 contact-info">
                <div class="mb-3 info-item d-flex" data-aos="fade-up" data-aos-delay="300">
                  <i class="bi bi-envelope-at me-3"></i>
                  <span>info@example.com</span>
                </div>

                <div class="mb-3 info-item d-flex" data-aos="fade-up" data-aos-delay="400">
                  <i class="bi bi-telephone me-3"></i>
                  <span>+1 5589 55488 558</span>
                </div>

                <div class="mb-4 info-item d-flex" data-aos="fade-up" data-aos-delay="500">

                    ...
                    <tbody>
                        ...
                        <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                            ...
                            <td class="text-center align-midle">
                                ...
                                @if ($item->status == 1)
                                @if ($item->selection == 1)
                                <button wire:click="selectItem('{{ $item->id }}', 'primary')" class="btn btn-xs btn-info" title="Change to primary" @if (auth()->user()->can('postsubcribe.create')) hidden @endif>
                                ...
                                @endif
                                @endif
                                <a title="Edit" class="btn btn-xs btn-warning edit-row" href="{{ route('backend.blog.edit', $item->id) }}">
                                ...
                                @else
                                <button title="Forbidden" class="btn btn-xs btn-default" title="Change to Selection">
                                    <i class="fa fa-bookmark" aria-hidden="true"></i>
                                </button>
                                <button title="Forbidden" class="btn btn-xs btn-default" title="Change to  Headline">
                                    <i class="fa fa-window-maximize"></i>
                                </button>
                                <button title="Forbidden" class="btn btn-xs btn-default" title="Change to Publish">
                                    <i class="fa fa-eye"></i>
                                </button>

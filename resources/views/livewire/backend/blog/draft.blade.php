<div>
    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                    ...
                    <tbody>
                        ...
                        <tr class="@if ($this->isChecked($item->id))
                            ...
                            <td class="text-center align-midle">
                                ...
                                <a title="Edit" class="btn btn-xs btn-warning edit-row" href="{{route('backend.blog.edit', $item->id)}}"><i class="fa fa-edit"></i></a>
            ...
            @else
            <hr>
            <h2 style="color: red" class="text-center">Blog Draft not available</h2>
            @endif
        </div>
    </div>

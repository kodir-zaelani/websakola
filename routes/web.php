...
// Route::get('berita-kategori/{slug}', App\Livewire\Frontend\Post\Categories::class)->name('post.category');
...
Route::middleware(['auth', 'verified', 'web'])->group(function () {
    ...
    Route::get('backend/blog/{post}/edit', [App\Http\Controllers\Backend\BlogController::class, 'edit'])->name('backend.blog.edit');
    Route::put('backend/blog/{post}/update', [App\Http\Controllers\Backend\BlogController::class, 'update'])->name('backend.blog.update');
